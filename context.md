...
*   **Architecture**: Angular 19 frontend application with a "Flacon Brut" (Modern Avant-Garde) dark mode design system (`#121212` background, emerald accents `#022C22`/`#065F46`/`#059669`, `#E5E4E2` text).
