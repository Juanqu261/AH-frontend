...
*   **Architecture**: Angular 19 frontend application with a "Flacon Brut" (Modern Avant-Garde) dark mode design system (`#121212` background, purple accents `#2B1B3D`/`#4A2D6B`/`#6B3FA0`, `#E5E4E2` text).
